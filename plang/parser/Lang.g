...
statement: 
      s_block=block
    | s_empty=emptyStatement
    | s_expression=expressionStatement
    | s_if=ifStatement
...
//
arguments: 
    OpenParen args=argumentslist? CloseParen
    ;
...
singleExpression: 
    ...
    // <e1> >> <e2>
    //
    | singleExpression etype=(LeftShiftArithmetic | RightShiftArithmetic ) singleExpression                # BitShiftExpression
    ...
    // <e1> != <e2>
    //
    | singleExpression etype=(Equals | NotEquals) singleExpression              # EqualityExpression
